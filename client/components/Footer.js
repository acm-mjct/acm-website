  ...
  <div className="border-t border-gray-800">
    <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
      <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
        ...
        <button className="inline-flex text-black bg-wheaty border-0 py-2 px-6 focus:outline-none hover:bg-navy rounded-lg hover:text-wheaty hover:border-wheaty hover:outline-double">Button</button>
  ...
  <div className="bg-navy bg-opacity-75">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-400 text-sm text-center sm:text-left">© 2020 Tailblocks —
        <a href="https://www.youtube.com/watch?v=zdwc_bIlejk" className="text-gray-500 ml-1 cursor-pointer" target="_blank" rel="noopener noreferrer">@knyttneve</a>
      </p>
